...
/**
 * RDF Tutorial example 08: executing a simple SPARQL query on the database
 *
 * @author Jeen Broekstra
 */
public class Example08SimpleSPARQLQuery {
			...
			throws IOException
	{
		...
		try (RepositoryConnection conn = db.getConnection()) {
			...
			try (InputStream input =
					Example08SimpleSPARQLQuery.class.getResourceAsStream("/" + filename)) {
