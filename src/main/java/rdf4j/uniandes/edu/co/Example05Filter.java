...
/**
 * RDF Tutorial example 05: Reading a Turtle syntax file to create a Model
 *
...
public class Example05Filter {
	...
	public static void main(String[] args) throws IOException {
		...
		InputStream input = Example05Filter.class.getResourceAsStream("example-data-artists.ttl");
